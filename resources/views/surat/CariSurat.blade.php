      ...
      <ul class="nav navbar-nav">
        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Filter<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <span class="label label-info">Jenis Surat</span>
        <li><input type="checkbox" value="">Surat Masuk</li>
              <li><input type="checkbox" value="">Surat Keluar</li>
            <li role="separator" class="divider"></li>
            <span class="label label-warning">Berdasarkan</span>
              <li><input type="radio" name="sort">Nama Surat</li>
            <li><input type="radio" name="sort">Tag Surat</li>
          </ul>
        </li>
      </ul>
